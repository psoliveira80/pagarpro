...
@Component({
  selector: 'app-relatorio-builder',
  standalone: true,
  imports: [UiIconComponent, FormsModule, ModalComponent],
  templateUrl: './relatorio-builder.component.html',
  styleUrl: './relatorio-builder.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RelatorioBuilderComponent {
