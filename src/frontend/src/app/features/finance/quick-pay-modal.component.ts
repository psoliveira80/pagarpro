...
@Component({
  selector: 'app-quick-pay-modal',
  standalone: true,
  imports: [FormsModule, CustomSelectComponent, ModalComponent],
  templateUrl: './quick-pay-modal.component.html',
  styleUrl: './quick-pay-modal.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class QuickPayModalComponent implements OnInit {
