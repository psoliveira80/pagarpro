...
import { PayableFormDrawerComponent } from './payable-form-drawer.component';
import { QuickPayModalComponent } from './quick-pay-modal.component';

@Component({
  selector: 'app-payables-list',
  standalone: true,
  imports: [FormsModule, UiIconComponent, PayableFormDrawerComponent, QuickPayModalComponent, CustomSelectComponent, ModalComponent],
  templateUrl: './payables-list.component.html',
  styleUrl: './payables-list.component.css',
