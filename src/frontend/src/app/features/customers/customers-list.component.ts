...
export class CustomersListComponent implements OnInit, OnDestroy {
  ...
  // Uses wizard pattern (same as vehicles/contracts) — navigates to /customers/new
  ...
  openCreateWizard(): void {
    this.router.navigate(['/system/customers/new']);
  }

  openEditWizard(customer: Cliente): void {
    this.router.navigate(['/system/customers', customer.id, 'edit']);
  }

  viewCustomer(customer: Cliente): void {
    this.router.navigate(['/system/customers', customer.id]);
  }
