...
@Component({
  ...
  standalone: true,
  templateUrl: './customer-dashboard-tab.component.html',
  styleUrl: './customer-dashboard-tab.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CustomerDashboardTabComponent implements OnInit {
