...
@Component({
  selector: 'app-financeiro-configuracoes',
  standalone: true,
  imports: [],
  templateUrl: './financeiro-configuracoes.component.html',
  styleUrl: './financeiro-configuracoes.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FinanceiroConfiguracoesComponent implements OnInit {
