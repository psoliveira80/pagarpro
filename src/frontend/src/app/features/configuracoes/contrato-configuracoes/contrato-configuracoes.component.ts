...
@Component({
  selector: 'app-contrato-configuracoes',
  standalone: true,
  imports: [],
  templateUrl: './contrato-configuracoes.component.html',
  styleUrl: './contrato-configuracoes.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ContratoConfiguracoesComponent implements OnInit {
