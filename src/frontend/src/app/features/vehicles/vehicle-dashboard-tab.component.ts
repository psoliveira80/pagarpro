...
@Component({
  selector: 'app-vehicle-dashboard-tab',
  standalone: true,
  templateUrl: './vehicle-dashboard-tab.component.html',
  styleUrl: './vehicle-dashboard-tab.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VehicleDashboardTabComponent implements OnInit {
