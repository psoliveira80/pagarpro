...
@Component({
  selector: 'app-frota-mapa',
  standalone: true,
  imports: [UiIconComponent],
  templateUrl: './frota-mapa.component.html',
  styleUrl: './frota-mapa.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FrotaMapaComponent implements OnInit, OnDestroy {
