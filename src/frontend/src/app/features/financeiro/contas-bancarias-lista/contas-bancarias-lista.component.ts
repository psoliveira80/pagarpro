...
@Component({
  selector: 'app-contas-bancarias-lista',
  standalone: true,
  imports: [FormsModule, UiIconComponent, CustomSelectComponent, ModalComponent],
  templateUrl: './contas-bancarias-lista.component.html',
  styleUrl: './contas-bancarias-lista.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ContasBancariasListaComponent implements OnInit {
