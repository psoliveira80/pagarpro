...
@Component({
  selector: 'app-divergencias',
  standalone: true,
  imports: [UiIconComponent],
  templateUrl: './divergencias.component.html',
  styleUrl: './divergencias.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DivergenciasComponent implements OnInit {
