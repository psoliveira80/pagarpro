...
import { BaixaModalComponent } from '../baixa-modal/baixa-modal.component';
import { PixQrModalComponent } from '../pix-qr-modal/pix-qr-modal.component';
import { RenegociacaoModalComponent } from '../renegociacao-modal/renegociacao-modal.component';
import { ConfirmService } from '../../../shared/services/confirm.service';

@Component({
  selector: 'app-titulos-receber-lista',
  standalone: true,
  imports: [FormsModule, UiIconComponent, BaixaModalComponent, PixQrModalComponent, RenegociacaoModalComponent, CustomSelectComponent],
  templateUrl: './titulos-receber-lista.component.html',
  styleUrl: './titulos-receber-lista.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TitulosReceberListaComponent implements OnInit, OnDestroy {
