...
@Component({
  selector: 'app-fila-validacao',
  standalone: true,
  imports: [UiIconComponent],
  templateUrl: './fila-validacao.component.html',
  styleUrl: './fila-validacao.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FilaValidacaoComponent implements OnInit {
