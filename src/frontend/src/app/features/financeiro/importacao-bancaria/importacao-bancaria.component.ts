...
@Component({
  selector: 'app-importacao-bancaria',
  standalone: true,
  imports: [FormsModule, UiIconComponent, CustomSelectComponent],
  templateUrl: './importacao-bancaria.component.html',
  styleUrl: './importacao-bancaria.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ImportacaoBancariaComponent implements OnInit {
